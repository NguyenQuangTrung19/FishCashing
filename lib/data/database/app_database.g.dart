...
class StoreInfo extends DataClass implements Insertable<StoreInfo> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, address, phone, logoPath, qrImagePath, syncedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is StoreInfo &&
...
class InventoryAdjustment extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, productId, quantityInGrams, reason, createdAt, syncedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Payment extends DataClass implements Insertable<Payment> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, orderId, amountInCents, note, createdAt, syncedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Payment &&
...
final class $$TradeOrdersTableReferences
  ...
  static MultiTypedResultKey<$PaymentsTable, List<Payment>> _paymentsRefsTable(
    ...
    db.payments,
    aliasName: $_aliasNameGenerator(db.tradeOrders.id, db.payments.orderId),
  );
...
final class $$PaymentsTableReferences
  ...
  static $TradeOrdersTable _orderIdTable(_$AppDatabase db) =>
      db.tradeOrders.createAlias(
        $_aliasNameGenerator(db.payments.orderId, db.tradeOrders.id),
      );
